...
if(isset($_POST['save'])){    
    ...
    if($vendor_sell_vegetables==""){
		$vendor_sell_vegetables=0;
	}
	if($vendor_sell_fruits==""){
		$vendor_sell_fruits=0;
	}
    ...
    if(mysql_query($updatequery)){
		if($vendor_sell_vegetables==0){
			 $update_vegetables  ="update vendor_product_list set product_active_status ='0' where vendor_id='".$vendor_id."' AND product_type_id='2'";
				$execute_vegetables=mysql_query($update_vegetables);
			}else{
				$update_vegetables  ="update vendor_product_list set product_active_status ='1' where vendor_id='".$vendor_id."' AND product_type_id='2'";
				$execute_vegetables=mysql_query($update_vegetables);
				}
			if($vendor_sell_fruits==0){
			 $update_fruits  ="update vendor_product_list set product_active_status ='0' where vendor_id='".$vendor_id."' AND product_type_id='1'";
				$execute_fruits=mysql_query($update_fruits);
			}else{
				$update_fruits  ="update vendor_product_list set product_active_status ='1' where vendor_id='".$vendor_id."' AND product_type_id='1'";
				$execute_fruits=mysql_query($update_fruits);
				}
