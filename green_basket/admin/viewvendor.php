...
$city_name_result = mysql_query("SELECT distinct city_name from area_details order by city_name");
  ...
  $vendor_result = mysql_query("SELECT vendor_id, vendor_shop_name, vendor_city, vendor_email, vendor_mobile_number, vendor_area, vendor_shop_address, vendor_latitude, vendor_longitude, vendor_signup_date_time, vendor_approve_status from vendor_signup order by vendor_signup_date_time desc");   
?>
...
<script>
/* Get vendors record according to city name from vendor signup table*/
