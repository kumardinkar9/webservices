...
<body>
	...
	<section id="main" class="column">
		...
		<div class="tab_container">
			...
			<tbody >
                  		<tr>
							<td colspan="2" align="center"><a href="forgotPassword.php" style="text-decoration:underline; font-size:25px;">forgot password?</a></td>
							
                  		</tr>	
			</tbody>   
			<tbody >
                  		<tr>
							<td colspan="2" align="center"><input type="submit" value="LogOn" title="Submit" name="LoginUser" style="width: 110px !important;margin: 0px 138px;"></td>
