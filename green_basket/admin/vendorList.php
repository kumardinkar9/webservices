...
if($vendor_city != ""){
 ...
 $vendor_result = mysql_query("SELECT vendor_id, vendor_shop_name, vendor_city, vendor_email, vendor_mobile_number, vendor_area, vendor_shop_address, vendor_latitude, vendor_longitude, vendor_signup_date_time, vendor_approve_status from vendor_signup where vendor_city = '".$vendor_city."' order by vendor_signup_date_time desc");                        
                               $countrecord    =   0;
                            $i=1;
	...
	$vendor_result = mysql_query("SELECT vendor_id, vendor_shop_name, vendor_city, vendor_area, vendor_shop_address, vendor_latitude, vendor_longitude, vendor_signup_date_time, vendor_approve_status from vendor_signup order by vendor_signup_date_time desc");                        
 $countrecord    =   0;
                              $countrecord    =   0;
                            $i=1;
                            while($vendordetails=mysql_fetch_array($vendor_result))  //carry on looping through while there are records
