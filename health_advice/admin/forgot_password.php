 ...
 */
define('PAGENAME', 'forgotPasswordpage', true);
include('config.php');  // require or include, config.php from include folder
include('header_forgot_password.php');  // require or include, headerForgotPassword.php from include folder
$email=$_POST['email'];
if($_POST['submit']){
	if($_POST['email'] == ""){
...
<section id="main" class="column" style="width:100%">		
		<h4 class="alert_info">Welcome to the Family Health Admin Panel </h4>		
